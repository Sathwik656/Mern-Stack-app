...
import progressSerivice from '../../services/progressService'
...
const DashboardPage = () => {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        const data = await progressSerivice.getDashboardData()
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="group bg-white/90 backdrop-blur-xl border border-slate-200/60 rounded-2xl 
             shadow-lg shadow-slate-200/60 p-6
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                {/* Icon */}
                <div
                  className={`w-11 h-11 rounded-xl bg-gradient-to-br ${stat.gradient} 
                  ${stat.shadowColor}
        ...
        .map((activity, index) => (
          ...
          >
            ...
            {activity.link && (
              <a
                href={activity.link}
                className="ml-6 px-4 py-2 text-xs font-semibold text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition-all duration-200 whitespace-nowrap self-center"
              >
                View
              </a>
            )}
