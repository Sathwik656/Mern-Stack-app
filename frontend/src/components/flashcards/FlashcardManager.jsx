...
const FlashcardManager = ({ documentId }) => {
    ...
    const handleGenerateFlashcards = async () => {
        ...
        try {
            ...
            toast.error(error.message || "Falied to generate flashcards.")
        } finally {
            setGenerating(false);
        }
    }
            ...
            return (
                <div className="flex flex-col items-center justify-center py-16 px-6">
                    ...
                    <p className="text-sm text-slate-500 mb-8 text-center max-w-sm">
                        Generate Flashcards from your document to start learningand reinforce your knowledge.
                    </p>
                    <button
            ...
            >
                <div className="space-y-6">
                    <p className="text-sm text-slate-600">
                        Are you sure you want to delete this flashcards set? This action cannot be undone and all cards will be permanently removed.
                    </p>
