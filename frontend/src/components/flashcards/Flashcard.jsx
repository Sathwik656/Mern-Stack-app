...
const Flashcard = ({flashcard, onToggleStar}) => {
    ...
    return <div className="relative w-full h-72" style={{perspective: '100px'}}>
        <div
            className={`relativew w-full h-full transition-transform duration-200 transform`}
            style={{
                    ...
                    <button
                        ...
                        className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200 ${
                            flashcard.isStarred
                                ...
                                : 'bg-white/20 backdrup-blut-sm text-white/70 hover:bg-white/30 hover:text-white border border-white/20'
                        }`}
                    >
                        <Star 
                            className="w-4 h-4"
